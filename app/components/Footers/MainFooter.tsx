                ...
                <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <Image
                            ...
                            alt=""
                        />
                        <span className="ml-3 text-xl">FITSII</span>
                    </a>
                    <p className="mt-2 text-sm text-gray-500">Get more from every workout with customized guideance of personal training</p>
                </div>
                <div className="flex-grow flex flex-wrap md:pl-10 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    <div className="md:w-1/3 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            ...
                            <li>
                                <Link href="/contact" >
                                    <a className="text-gray-600 hover:text-gray-800">Copyright Issue</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" >
                    ...
                    <div className="md:w-1/3 w-full px-4">
                        ...
                        <nav className="list-none mb-10">
                            <li>
                                <Link href="/contact" >
                                    <a className="text-gray-600 hover:text-gray-800">Become Teacher</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" >
                                    <a className="text-gray-600 hover:text-gray-800">Become Student</a>
                                </Link>
                            </li>
                            <li>
                                <Link href="/contact" >
                    ...
                    <div className="md:w-1/3 w-full px-4">
                        <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Download App</h2>
                        <nav className="list-none mb-10">
                            <li>
                                <a className="bg-gray-200 inline-flex py-3 px-3 rounded-lg items-center hover:bg-gray-300 focus:outline-none ">
                                    ...
                                    <span className="ml-4 flex items-start flex-col leading-none text-green-800">
                                        <span className="title-font font-medium">Google Play</span>
                                    </span>
                                </a>
                            </li>
                            <li className="mt-2">
                                <a className="bg-gray-200 inline-flex py-3 px-3 rounded-lg items-center md:ml-0  md:mt-4 mt-0 lg:mt-0 hover:bg-gray-300 focus:outline-none">
                                    ...
                                    <span className="ml-4 flex items-start flex-col leading-none text-gray-800">
